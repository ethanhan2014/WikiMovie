        ...
        copy: {
            ...
            js: {
                files: [
                    ...
                    {cwd: 'bower_components/bootstrap/docs/dist/css',                    src: ['*.*'],    dest: 'public/lib/bootstrap/docs/dist/css', expand: true},
                    {cwd: 'bower_components/bootstrap/docs/dist/fonts',                  src: ['*.*'],    dest: 'public/lib/bootstrap/docs/dist/fonts', expand: true},
                    {cwd: 'bower_components/bootstrap/docs/dist/js',                     src: ['*.*'],    dest: 'public/lib/bootstrap/docs/dist/js', expand: true},
                    {cwd: 'bower_components/jquery',                                     src: ['jquery*'], dest: 'public/lib/jquery', expand: true},
                    {cwd: 'bower_components/d3',                                         src: ['d3*'], dest: 'public/lib/d3', expand: true},
                    {cwd: 'bower_components/webcola/WebCola',                            src: ['cola*'], dest: 'public/lib/webcola', expand: true}
                ]
            }
        },
        nodemon: {
